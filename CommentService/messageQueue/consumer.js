...
const runConsumer = async () => {
    try {
        ...
        // Subscribe to topics
        // await consumer.subscribe({ topic: process.env.TASK_CREATED_TOPIC, fromBeginning: true });
        // await consumer.subscribe({ topic: process.env.TASK_UPDATED_TOPIC, fromBeginning: true });
        // await consumer.subscribe({ topic: process.env.TASK_DELETED_TOPIC, fromBeginning: true });
